...
Model: gemma4:12b-q4_k_m (configured via OLLAMA_MODEL env var)
...
class GemmaClient:
    ...
    Attributes:
        model: Ollama model identifier (e.g. "gemma4:12b-q4_k_m").
        host: Ollama server URL (e.g. "http://localhost:11434").
        timeout: Request timeout in seconds.
    """

    DEFAULT_MODEL = "gemma4:12b-q4_k_m"
    ...
    def is_available(self) -> bool:
        ...
        Example:
            ...
            ...     print("Run: ollama serve && ollama pull gemma4:12b-q4_k_m")
        """
